...
\zero\ and \one\ symbols. 
However, data transmission happens in the real world, where \zero\ and \one\ are ideas and not tangible objects.
...
electromagnetic \concept{field} using antennas.
...
If we opt for copper wires, we can put several in \concept{parallel} and send more data at the same clock speed.
