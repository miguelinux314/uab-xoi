...
For instance, Alice may perform a fully \conceptRef{iterative}{iterative resolution} all on her own.
...
The combination of \conceptRef{recursive}{recursive resolution} and \concept{cache} tables makes
