...
In this way, \conceptRef{multimodal}{multi-modal optical fiber} allows \conceptRef{multiplex}{multiplexing}
...
and the data are encoded by modifying this carrier. For instance, one can change the \concept{amplitude} of the carrier (ASK),
