...
\begin{remark}
It is also possible to signal the \textit{beginning} of a packet. In that case, a preceding sequence called \concept{preamble} is used.
\end{remark}
...
in which case its is normally called a \concept{flag} or flag bit.
\end{remark}
