...
Many \concept{protocols} have been and are being defined within Layer~2. Most importantly nowadays:\\[-0.6cm]
\begin{itemize}
...
\subsection*{Practical aspects}\label{sec:layer2:practical}
